...
ssql6="select * from daha where cstr(ids)='"&iduse& "' order by id desc"
...
Response.Write "<a href='myzl.asp?pages=" & (pages+1) & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "|" & "<a href='myzl.asp?pages=" & (pages-1) & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
