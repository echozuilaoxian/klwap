...
set rs9=Server.CreateObject("ADODB.Recordset")
       ssql="select * from longdate where CStr(id)='6'"
...
response.write "<br/>"&rs9("name")&"：<img src='img/6.gif' alt=''/><br/>剩余数量:"&rs9("so")&"个<br/>价格:"&rs9("jia")&"金币<br/>成熟用时:6小时"
%>
