...
if namorid="1" then
   ...
   namids="%" & namid & "%"
   ssql="select top 20 * from SoftDown_online where ip like '" & namids & "' order by id desc"
end if
...
Response.write bihao+bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & objgbrs("ids") & "&amp;SessionID=" & SessionID & "'>" & converttowidebaiti(objgbrs("name")) & "ID:" & objgbrs("ids") & "</a>(在线)<br/>"
objgbrs.Movenext
