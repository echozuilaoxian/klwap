...
Server.ScriptTimeout=999
  ...
  id=request("id")
  page=request("page")
  sql="update guestbook set bz=bz+1 Where CStr(id)='" & id & "'"
  Application.Lock
  conn.Execute(sql)
  Application.Unlock
...
Response.Write "<card id='card1' title='保存留言' ontimer='ckly.asp?pages=" & pages & "&amp;SessionID=" & SessionID & "'><timer value='10'/><p>"
