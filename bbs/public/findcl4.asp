...
if namorid="1" then
   ...
   namids="%" & namid & "%"
   ssql="select top 20 * from usereg where n like '" & namids & "' order by regtimes desc"
end if
...
Response.write "有缘查找共" & objgbrs.RecordCount & "位<br/>------------<br/>"
if pages=1 then
bihao=0
else
bihao=pages*20-20
...
Response.Write "<a href='findcl4.asp?pages=" & (pages+1) & "&amp;namid=" & namid & "&amp;namorid=" & namorid & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "&nbsp;" & "<a href='findcl4.asp?pages=" & (pages-1) & "&amp;namid=" & namid & "&amp;namorid=" & namorid & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
if objgbrs.PageCount>1 then
