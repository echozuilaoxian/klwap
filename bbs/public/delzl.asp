...
lasttls
  dim page,bz,objgbrs
  page=request("page")
  sql="Delete FROM delzl WHERE DATEDIFF('s', times, now()) > 5543200*60"
  conn.Execute sql
  set objgbrs=Server.CreateObject("ADODB.Recordset")
  ssql="select * from delzl order by id desc"
...
Response.Write "<a href='delzl.asp?pages=" & (pages+1) & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "&nbsp;" & "<a href='delzl.asp?pages=" & (pages-1) & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
if objgbrs.PageCount>1 then
...
set conn=nothing
Response.Write "-------------<br/>"
Response.Write "<a href='/bbs/ztlb.asp?SessionID=" & SessionID & "'>返回论坛首页</a><br/><a href='/bbs/index.asp?SessionID=" & SessionID & "'>返回社区首页</a></p></card></wml>"
%>
