...
lasttls
  ...
  set objgbrs=Server.CreateObject("ADODB.Recordset")
   ssql="select top 5000 id,usename from usereg where usesex like '1' order by regtimes desc"
...
Response.write "最新注册" & objgbrs.RecordCount & "位美女<br/>------------<br/>"
if pages=1 then
bihao=0
else
bihao=pages*10-10
...
Response.Write "<a href='findcl3.asp?pages=" & (pages+1) & "&amp;namid=" & namid & "&amp;namorid=" & namorid & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "&nbsp;" & "<a href='findcl3.asp?pages=" & (pages-1) & "&amp;namid=" & namid & "&amp;namorid=" & namorid & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
if objgbrs.PageCount>1 then
