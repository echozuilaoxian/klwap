...
if objgbrr.RecordCount>500 then
   Response.write "您保留的旧信息超过了500条,暂时不能发信或回复,请删除一些没用的留言！<br/>------------<br/><a href='srxx.asp?SessionID=" &SessionID& "'>返回我的信箱</a><br/><a href='/bbs/index.asp?SessionID=" & SessionID & "'>返回社区首页</a></p></card></wml>"
objgbrr.close
set objgbrr=nothing
   response.end
End if
...
Set rs= Nothing
End if
response.write"------------<br/><a href='/bbs/public/main_fs.asp?SessionID=" & SessionID & "'>返回继续发信</a><br/>"
...
if Session("returnuppath")<>"" then
  ...
  Else
End if
Response.write "<a href='/bbs/friandbook/myfriend.asp?SessionID=" &SessionID& "'>返回我的好友</a><br/><a href='/bbs/index.asp?SessionID=" &SessionID& "'>返回社区首页</a><br/>"
