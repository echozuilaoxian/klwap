...
if objgbrs.eof then
  ...
  set objgbrs=nothing
  set conn=nothing
  response.write "操作成功！！<br/><a href='myalbum.asp?id=" &id & "&amp;SessionID=" & SessionID & "'>回看相片</a><br/><a href='index.asp?SessionID=" & SessionID & "'>返回相册</a><br/><a href='/bbs/index.asp?SessionID=" & SessionID & "'>社区首页</a></p></card></wml>"
End if
%>
