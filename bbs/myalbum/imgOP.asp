...
bz=""
End if
Response.write bihao+bihaocont & "." & "<anchor>" &  bz & converttowide(objgbrs("niayo")) & "<go method='post' href=""/BBS/Forum_content/Forum_Addcontent_opera.Asp?ForumID="&ForumID&"&amp;Page="&Page&"&amp;Mon="&mon&"&amp;SessionID="&SessionID&"""><postfield name='img' value='" & objgbrs("xclink") & "'/><postfield name='imgs' value='(img)" & objgbrs("xclink") & "(/img)'/><postfield name='wen' value='[图]'/><postfield name='nais' value='" & objgbrs("niayo") & "'/></go></anchor><br/>"
...
Response.Write "<a href='ImgOP.asp?ForumID=" & ForumID & "&amp;Page="&Page&"&amp;Mon="&mon&"&amp;Pages=" & (pages+1) & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "&nbsp;" & "<a href='ImgOP.asp?ForumID=" & ForumID & "&amp;Page="&Page&"&amp;Mon="&mon&"&amp;Pages=" & (pages-1) & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
