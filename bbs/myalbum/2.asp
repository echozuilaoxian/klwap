...
response.write "<a href='index.asp?wap=" & wap & "'>精彩相册</a>-<a href='/bbs/index.asp?wap=" & wap & "'>社区首页</a></p></card></wml>"
	conn.close
	set objgbrs=nothing
	Set conn = Nothing
%>
