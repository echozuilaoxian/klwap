...
<anchor>确定修改<go href='Admin_system.asp?kyzc=kyaa_cl&amp;SessionID=<%=request("SessionID")%>' method='post' accept-charset='utf-8'>
...
<anchor>修改<go href='Admin_system.asp?kyzc=kywap_net&amp;SessionID=<%=request("SessionID")%>' method='post' accept-charset='utf-8'>
...
set myc=nothing
%>
<a href="Admin.Asp?SessionID=<%=request("SessionID")%>">返回管理</a><br/>
<a href="index.asp?SessionID=<%=request("SessionID")%>">返回社区首页</a><br/>
报时:<%=time%>
</p></card></wml>
