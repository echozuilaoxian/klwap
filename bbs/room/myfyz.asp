...
<%
response.write "<br/><a href='myfy1.asp?id=" & id & "&amp;ids=" & ids & "&amp;SessionID=" & SessionID & "'>切换至发言>></a><br/><a href='myfyb.asp?id=" & id & "&amp;ids=" & ids & "&amp;SessionID=" & SessionID & "'>切换至贴图>></a>"
