...
if idlt=id or idlt=1000 or idlt=1 or idlt=10000 or idlt=100000 or idlt=2 then

Function AAA()
response.write "请选择你要进行的操作<br/>"
response.write "<a href='roomgl.asp?id=" & id & "&amp;ck=bb&amp;SessionID=" & SessionID & "'>禁止室员</a><br/>"
response.write "<a href='roomgl.asp?id=" & id & "&amp;ck=cc&amp;SessionID=" & SessionID & "'>解禁室员</a><br/>"
response.write "<a href='roomgl.asp?id=" & id & "&amp;ck=dd&amp;SessionID=" & SessionID & "'>清空发言</a><br/>"
response.write "<a href='roomgl.asp?id=" & id & "&amp;ck=ee&amp;SessionID=" & SessionID & "'>关闭聊室</a><br/>"
End Function
...
sql="select * from ooo where idd=" & id & " and idlt<>" & idlt & " and DATEDIFF('s', times, now()) < 15*60 order by id desc"
rs.open sql,myc,1,1
if rs.eof then
response.write "嘿嘿，现在都还没有人呢，不用担心会有人捣乱啦<br/>"
  else
response.write "禁止<br/><select name='about'>"

 do while not rs.eof
  response.write "<option value='" & ubb(rs("idlt")) & "'>" & ubb(rs("name")) & "ID:" & ubb(rs("idlt")) & "</option>"
  rs.Movenext
loop
response.write "理由:<input type='text' name='word1' size='12'/>"
response.write "</select><br/>"
response.write "<select name='glcz'>"
...
response.write "<a href='roomgl.asp?ck=ok&amp;cz=qk&amp;id=" & id & "&amp;SessionID=" & SessionID & "'>确定</a><br/>"
End Function


Function EEE()
response.write "发言也会全部清除的,确定关闭吗?<br/>"
response.write "<a href='roomgl.asp?ck=ok&amp;cz=gb&amp;id=" & id & "&amp;SessionID=" & SessionID & "'>确定</a><br/>"
End Function
...
<%end if%>
---------<br/>
<a href="roomgl.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>">[管理页面]</a><br/>
