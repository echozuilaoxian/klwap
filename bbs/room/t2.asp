...
编号11<img src='image/11.gif' alt='load...'/><br/>
编号12<img src='image/12.gif' alt='load...'/><br/>
编号13<img src='image/13.gif' alt='load...'/><br/>
编号14<img src='image/14.gif' alt='load...'/><br/>
编号15<img src='image/15.gif' alt='load...'/><br/>

<a href="t3.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">下一页</a>|
<a href="t1.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">上一页</a><br/>
<br/>--------<br/>
<%if oo="room" then%>
