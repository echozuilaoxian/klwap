...
response.write "<a href='zx.asp?id=" & id & "&amp;SessionID=" & SessionID & "'>找人聊聊</a><br/>"%>
表情2:
...
sqls1="select * from ooo where iidd=" & id & " and DATEDIFF('s', times, now()) < 15*60 order by id desc"
