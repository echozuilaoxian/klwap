...
编号21<img src='image/21.gif' alt='load...'/><br/>
编号22<img src='image/22.gif' alt='load...'/><br/>
编号23<img src='image/23.gif' alt='load...'/><br/>
编号24<img src='image/24.gif' alt='load...'/><br/>
编号25<img src='image/25.gif' alt='load...'/><br/>

<a href="t5.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">下一页</a>|
<a href="t3.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">上一页</a><br/>
<br/>--------<br/>
<%if oo="room" then%>
