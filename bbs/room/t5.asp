...
编号26<img src='image/26.gif' alt='load...'/><br/>
编号27<img src='image/27.gif' alt='load...'/><br/>
编号28<img src='image/28.gif' alt='load...'/><br/>
编号29<img src='image/29.gif' alt='load...'/><br/>
编号30<img src='image/30.gif' alt='load...'/><br/>

<a href="t6.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">下一页</a>|
<a href="t4.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">上一页</a><br/>
<br/>--------<br/>
<%if oo="room" then%>
