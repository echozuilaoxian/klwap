...
编号41<img src='image/41.gif' alt='load...'/><br/>
编号42<img src='image/42.gif' alt='load...'/><br/>
编号43<img src='image/43.gif' alt='load...'/><br/>

<a href="t7.asp?id=<%=id%>&amp;SessionID=<%=SessionID%>&amp;t=<%=t%>&amp;oo=<%=oo%>">上一页</a><br/>
<br/>--------<br/>
<%if oo="room" then%>
