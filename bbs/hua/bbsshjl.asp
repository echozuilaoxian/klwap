...
'========================================================================================
%>
<%=(j+(page-1)*listnum)%>:<b><u><%=ubb(rs("vote"))%>向<%=ubb(rs("addvote"))%></u></b>送了一朵<img src='/bbs/xhjy/hua/<%=rs("voteID")%>.gif' alt=''/>[<%=rs("AfficheTime")%>]<br/>
<%rs.movenext 
j=j+1 
loop%>
...
<b>注：此处只显示广播送花的记录</b>
<br/>------------<br/>
<a href="/bbs/hua/index.asp?SessionID=<%=SessionID%>">返回社区花园</a><br/>
