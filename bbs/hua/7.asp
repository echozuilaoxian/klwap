...
set rs9=Server.CreateObject("ADODB.Recordset")
       ssql="select * from huadate where CStr(id)='8'"
...
response.write "<br/>"&rs9("name")&"：<img src='/bbs/xhjy/hua/7.gif' alt=''/><br/>剩余数量:"&rs9("so")&"个<br/>价格:"&rs9("jia")&"金币<br/>开花用时:6小时"
%>
