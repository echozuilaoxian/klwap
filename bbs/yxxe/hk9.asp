...
strsQL="select j2,bs,y6,hw1,hw2,hw3,hw4,hw5,hw6,hw7,hw8,hw9,hw10,hw11,hw12,hw13,hw14,hw15,yz,k8,k9 from wupin where cstr(ids)='"&ids& "'"
...
sql="update wupin set k8=k8-1 where cstr(ids)="&ids
  conn.Execute(sql)
sql="update wupin set k9=k9+1 where cstr(ids)="&ids
  conn.Execute(sql)
msg="您成功合成物品<b><u>神魔玄靴</u></b>"
END IF
end if
end if
end if
