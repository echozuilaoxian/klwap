...
Response.Write "--武器:" & wname & "<br/>--衣服:" & dname & "<br/>--靴子:" & kyaaname & "<br/>--头盔:" & touname & "<br/>--药品:" & yname & "<br/>--银两:" & yzname & "<br/>--卷轴:" & mmname & "<br/>--宝物:" & bsname & "<br/>--木料:" & mlname & "<br/>--金矿:" & jname & "<br/>--海鲜:" & hname & "<br/>--回城卷:" & hcjname & "<br/>--合成材料:" & hwname & "<br/>----------<br/>"
        rs.Close
	Set rs=Nothing
     liao.Close
      Set liao=Nothing
...
<a href="dan.asp?SessionID=<%=SessionID%>">[陈六当铺]</a><br/>
----------<br/>
