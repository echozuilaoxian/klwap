...
strsQL="select j2,bs,y6,hw1,hw2,hw3,hw4,hw5,hw6,hw7,hw8,hw9,hw10,hw11,hw12,hw13,hw14,hw15,yz,d8,d9 from wupin where cstr(ids)='"&ids& "'"
...
sql="update wupin set d8=d8-1 where cstr(ids)="&ids
  conn.Execute(sql)
sql="update wupin set d9=d9+1 where cstr(ids)="&ids
  conn.Execute(sql)
msg="您成功合成物品<b><u>神魔玄翼</u></b>"
END IF
end if
end if
end if
