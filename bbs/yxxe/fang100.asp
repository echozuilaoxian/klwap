...
if rs1.eof then
Response.Write "怪物已被你打死！还不放过它吗？<a href='xluo2.asp?SessionID="&SessionID&"'>继续江湖</a><br/>"
else
if rs1("tl")>=1 then
gwsx=clng(rs1("fs"))
mysx=clng(myfs)
...
Response.Write "防守中:<br/>怪物生命值-"&gwsx1&"<br/>("&gwjy1&"/"&rs1("jy")&")<br/>--------<br/>我的生命值-"&mysx1&"<br/>("&mytl&"/"&myjy&")<br/><a href='ding1.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>攻击</a>|<a href='fang100.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>防守</a>|<a href='ttao100.asp?pid="&pid&"&amp;SessionID="&SessionID&"'>逃跑</a><br/>"
else
%>
...
sql="update sx set jy=jy+"&tsjy&" where cstr(ids)="&ids
  conn.Execute(sql)
Response.Write "怪物已被你打死！"&ddyz1&"经验提升"&tsjy&"!<br/>"&dengjiname&"<a href='emg.asp?SessionID="&SessionID&"'>[-继续-]</a><br/>"
end if
   rs1.close
set rs1=Nothing
end if
