...
<%end if%>
<br/>(<%=mytl%>/<%=myjy%>)
<br/>[<a href='gong8.asp?pid=<%=pid%>&amp;t=<%time%>&amp;SessionID=<%=SessionID%>'>攻击</a>][<a href='shou8.asp?pid=<%=pid%>&amp;t=<%time%>&amp;SessionID=<%=SessionID%>'>防守</a>]<br/>[<a href='yp.asp?pid=<%=pid%>&amp;SessionID=<%=SessionID%>'>吃药</a>][<a href='tao8.asp?pid=<%=pid%>&amp;SessionID=<%=SessionID%>'>逃跑</a>]<br/>
