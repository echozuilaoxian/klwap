...
sql="update sx set tl=tl-"&mysx1&" where cstr(ids)="&ids
  conn.Execute(sql)
Response.Write "逃跑失败了！凶猛的怪物扑了过来<br/>我的生命值-"&mysx1&"<br/>("&mytl&"/"&myjy&")<br/><a href='gong8.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>攻击</a>|<a href='shou8.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>防守</a>|<a href='tao8.asp?pid="&pid&"&amp;SessionID="&SessionID&"'>逃跑</a><br/>"
else
sql="delete from kywap Where CStr(ids)='" & ids & "'"
  conn.Execute(sql)
