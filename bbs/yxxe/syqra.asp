...
<card title="使用情人花" ontimer="index.asp?SessionID=<%=request("SessionID")%>">
<timer value="10"/>
<p>
...
if rs(""&wpid&"")<1 then
msg="您没有情人花！是不是忘记带眼镜啦~~"
else
set rs8=Server.CreateObject("ADODB.Recordset")
strsQL="select gj from sx where cstr(ids)='"&ids& "'"
