...
Response.Write "防守中:<br/>怪物生命值-"&gwsx1&"<br/>("&gwjy1&"/"&rs1("jy")&")<br/>--------<br/>我的生命值-"&mysx1&"<br/>("&mytl&"/"&myjy&")<br/><a href='kan7.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>攻击</a>|<a href='fang7.asp?pid="&pid&"&amp;t=" & time() & "&amp;SessionID="&SessionID&"'>防守</a>|<a href='ttao7.asp?pid="&pid&"&amp;SessionID="&SessionID&"'>逃跑</a><br/>"
else
%>
...
sql="update sx set jy=jy+"&tsjy&" where cstr(ids)="&ids
  conn.Execute(sql)
Response.Write "怪物已被你打死！"&ddyz1&"经验提升"&tsjy&"!<br/>"&dengjiname&"<a href='xluo2.asp?SessionID="&SessionID&"'>[-继续-]</a><br/>"
end if
   rs1.close
set rs1=Nothing
end if
