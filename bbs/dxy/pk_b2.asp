...
payjdcent=abs(int(objgbrss("num")*paylulu))
  ...
  conn.Execute(sql)  
    addlist2(myid)
 response.write "你选择:唐僧，对方选择了妖怪，很不幸，本次挑战你输了" & objgbrss("num") &getcent&"<br/>" 
            ltlyuan="你向会员:[" & myni & "ID:" & myid & "]发出的『斗西游』挑战,你选择:妖怪，对方选择唐僧，恭喜你，本次挑战你赢得了" & objgbrss("num") &getcent&"!"
gftz
id1=objgbrss("useid")
...
dim talk
talk="[" & rs1("usename") & "]赢了与[" & myni & "]『返回斗西游』的挑战!"
...
payjdcent=abs(int(objgbrss("num")*paylulu))
 ...
 response.write "恭喜你，你选择唐僧，对方选择了悟空,本次挑战，你赢了" & objgbrss("num") &getcent&"<br/>" 
            ltlyuan="你向会员:[" & myni & "ID:" & myid & "]发出的『斗西游』挑战,你选择:悟空，对方选择了唐僧，很不幸，本次挑战你输了" & objgbrss("num") &getcent&"!"
gftz
id1=objgbrss("useid")
  set rs1=Server.CreateObject("ADODB.Recordset")
  ssql1="select usename from [usereg] where [id]=" & id1 & " order by id desc"
...
objgbrss("about2")="C"
objgbrss.update 
 response.write "你选择唐僧，对方也选择了唐僧，本次挑战以平局结束！<br/>" 
            ltlyuan="你向会员:[" & myni & "ID:" & myid & "]发出的『斗西游』挑战,你选择:唐僧，对方也选择了唐僧，本次挑战以平局结束!"
