...
%>购买成功，你花了20枚金币<br/>
<a href='/bbs/shop/img/001.gif'>我要下载自已用</a><br/>
>输入你要赠送的ID
<br/><input type='text' format='*N' name='frid'/>
<br/>>您想对她/他说点什么呢？<br/><input name='ltlyuan' maxlength='200'/>
<br/><anchor>我要送给他/她<go href="addcl.asp?wap=<%=wap%>" method="post" accept-charset="utf-8">
<%
response.write "<postfield name='ltlyuan' value='您的朋友：" & converttowide(gfdsa) & "ID:" & objgbrs("id") & "给您发来一张贺卡“童年的记忆”\(img)/bbs/shop/img/001.gif(/img)他/她想对你说：$(ltlyuan)'/>"
