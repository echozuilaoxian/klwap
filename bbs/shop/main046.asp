...
%>购买成功，你花了20枚金币<br/>
<a href='/bbs/shop/img/046.gif'>>我要下载自已用</a><br/>
>输入你要赠送的ID
...
<%
response.write "<postfield name='ltlyuan' value='您的朋友：" & converttowide(gfdsa) & "ID:" & objgbrs("id") & "给您发来一张贺卡“生日献歌”\(img)/bbs/shop/img/046.gif(/img)他/她想对你说：$(ltlyuan)'/>"
