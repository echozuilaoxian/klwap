...
response.write "<img src='xunbao.gif' alt='宝箱'/><br/>"

       conn.Execute("update usereg set usejf=usejf+"&jb&" where id="&iduse)
dim talk
talk="" & Session("ltname") & "在(url=/bbs/xun/xunbao.Asp)深山寻宝(/url)找到了一顶(img)/bbs/xun/jin.gif(/img),价值" & jb & "金币"
sql="insert into sjzk(ids,dong,lasttlls,bu)values('"&iduse&"','"&talk&"','524','game')"
  Application.Lock
  conn.execute sql
  Application.Unlock

response.write "终于找到了宝贝！<br/>"
response.write "找到宝箱:宝箱放在"&dx&"号山洞<br/>你打开宝箱，得到了一顶金冠，拿到当铺当了:"&jb&"<br/>"
response.write "您来到了:"&num1&"号山洞<br/>"
else
response.write "小道消息:宝箱放在"&dx&"号山洞快去找<br/>"
response.write "您来到了"&num1&"号山洞<br/>"
