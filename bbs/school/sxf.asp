...
<%
  ...
  Response.write "我晕,你不是小学六年级的成员~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
    Response.end
  end if  
  '1
if objgbrs("xf")<3000 or objgbrs("qs")<6000 or objgbrs("love")<6000 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=6 and objgbrs("xf")>=3000 and objgbrs("qs")>=6000 and objgbrs("love")>=6000 then
sql="update usereg set nianji=7,xl=1 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜!已经小学毕业了,升初中了,要继续努力窝!!"
end if
