...
aaa=DateDiff("s", Session("RefreshTime"), Now())
     ...
     response.write "<br/><a href='/bbs/school/ren.asp?SessionID=" & SessionID & "'>&gt;等待&lt;</a>"
...
conn.Execute(sql)
response.write "由于你热心的帮助,赢得阵阵的赞许声!"
response.write "系统奖励情商+10，爱心+10，学分+1，体力-20<br/>"
response.write "你当前的属性：<br/>情商:"&objgbrs("qs")&"<br/>爱心:"&objgbrs("love")&"<br/>学分:"&objgbrs("xf")&"<br/>体力:"&objgbrs("tili")&""
response.write "<br/>------------<br/><a href='/bbs/school/ren.asp?SessionID="&SessionID&"'>&gt;继续助人&lt;</a>"
end if
