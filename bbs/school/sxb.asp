...
<%
  ...
  Response.write "我晕,你不是小学一年级的成员~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
  Response.end
  end if  
  '1
if objgbrs("xf")<1000 or objgbrs("qs")<2000 or objgbrs("love")<2000 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=2 and objgbrs("xf")>=1000 and objgbrs("qs")>=2000 and objgbrs("love")>=2000 then
sql="update usereg set nianji=3 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜!已经成为三年级的学生了!!"
end if
