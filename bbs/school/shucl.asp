...
aaa=DateDiff("s", Session("RefreshTime"), Now())
     ...
     response.write "<br/><a href='/bbs/school/shu.asp?SessionID=" & SessionID & "'>&gt;等待&lt;</a>"
...
<%
  ...
  if objgbrs("tili")>=20 then
  sql="update usereg set tili=tili-2,zhili=zhili+10,caihua=caihua+10,xf=xf+1 where Cstr(id)='"& iduse &"'"
conn.Execute(sql)
response.write "种树成功!<br/>"
response.write "系统奖励智力+10，才华+10，学分+1，体力-20<br/>"
response.write "你当前的属性：<br/>智力:"&objgbrs("zhili")&"<br/>才华:"&objgbrs("caihua")&"<br/>学分:"&objgbrs("xf")&"<br/>体力:"&objgbrs("tili")&""
response.write "<br/>------------<br/><a href='/bbs/school/shu.asp?SessionID="&SessionID&"'>&gt;继续种树&lt;</a>"
end if
