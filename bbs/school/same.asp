...
lasttls
  ...
  ssql="select * from usereg where nianji='"&idn&"' order by id"
...
Session("returnuppath")=Request.ServerVariables("PATH_INFO") & "idn="&idn&""
End if
Response.write "共有" & objgbrs.RecordCount & "名用户在该年级<br/>"
if pages=1 then
bihao=0
else
bihao=pages*10-10
...
Response.Write "<a href='/bbs/school/same.asp?idn="&idn&"&amp;pages=" & (pages+1) & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "|" & "<a href='/bbs/school/same.asp?idn="&idn&"&amp;pages=" & (pages-1) & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
if objgbrs.PageCount>1 then
response.write "&#40;" & pages & "&#47;" & objgbrs.PageCount & "&#41;<br/>"
response.write "<input  name='pages' value='2' size='2' format='*N'/><anchor>跳页<go method='post' href='/bbs/school/same.asp?idn="&idn&"&amp;SessionID=" & SessionID & "'><postfield name='pages' value='$(pages)'/></go></anchor>"
End if
