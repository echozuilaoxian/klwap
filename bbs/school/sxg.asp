...
<%
  ...
  Response.write "我晕,你不是初一的~~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
    Response.end
  end if  
  '1
if objgbrs("xf")<4500 or objgbrs("qs")<9000 or objgbrs("love")<9000 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=7 and objgbrs("xf")>=4500 and objgbrs("qs")>=9000 and objgbrs("love")>=9000 then
sql="update usereg set nianji=8 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜!已经升为初二的学生了,努力!!"
end if
