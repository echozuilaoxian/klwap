...
<%
  ...
  Response.write "我晕,你不是大二的~~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
    Response.end
  end if  
  '1
if objgbrs("xf")<12750 or objgbrs("qs")<25500 or objgbrs("love")<25500 then
...
sql="update usereg set nianji=15 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜,成为大三的了,继续努力!!"
end if
