...
<%
  ...
  Response.write "我晕,你不是小学五年级的成员~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
  Response.end
  end if  
  '1
if objgbrs("xf")<2500 or objgbrs("qs")<5000 or objgbrs("love")<5000 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=5 and objgbrs("xf")>=2500 and objgbrs("qs")>=5000 and objgbrs("love")>=5000 then
sql="update usereg set nianji=6 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜!已经成为五年级的学生了!!"
end if
