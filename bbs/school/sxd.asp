...
<%
  ...
  Response.write "我晕,你不是小学四年级的成员~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
  Response.end
  end if  
  '1
if objgbrs("xf")<2000 or objgbrs("qs")<4000 or objgbrs("love")<4000 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=4 and objgbrs("xf")>=2000 and objgbrs("qs")>=4000 and objgbrs("love")>=4000 then
sql="update usereg set nianji=5 where CStr(id)='" & iduse & "'"
conn.execute sql
