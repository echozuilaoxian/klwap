...
<%
  ...
  Response.write "我晕,你不是初二的~~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
    Response.end
  end if  
  '1
if objgbrs("xf")<5250 or objgbrs("qs")<10500 or objgbrs("love")<10500 then
Response.write "你的属性还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=8 and objgbrs("xf")>=5250 and objgbrs("qs")>=10500 and objgbrs("love")>=10500 then
sql="update usereg set nianji=9 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜!已经升为初三的学生了,努力!!"
end if
