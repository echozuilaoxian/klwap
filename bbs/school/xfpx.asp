...
<card id="card1" title="<%=converttowidebaiti(SystemSiteName)%>-学分排行"><p>
<% 
...
Response.write "<br/><a href='/bbs/mysx.asp?SessionID="&SessionID&"'>MY属性</a>|<a href='/bbs/public/ckly.asp?SessionID=" &SessionID & "'>留言(" & lycount & ")条</a>"
  ...
  ssql="select top 10 * from usereg order by xf desc"
  objgbrs.open ssql,conn
Response.write "<br/>社区学校学分排行前十：<br/>------------<br/>"
if objgbrs.eof then
Response.write "暂时空缺<br/>"
 Else
For k=1 to 10
bihaocont=bihaocont+1
Response.write bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & converttowidebaiti(objgbrs("usename")) & "ID:" & objgbrs("id") & "</a><br/>学分：(" & objgbrs("xf") & ")<br/>"
Response.write "当前年级:"
