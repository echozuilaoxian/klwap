...
<%
  ...
  '1
if objgbrs("xf")<30000 then
Response.write "你的学分还不够升学!回去学够才来吧~"
end if
if objgbrs("nianji")=17 and objgbrs("xf")>=30000 then
sql="update usereg set nianji=18,xl=6 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜,成为博士的了,继续努力!!"
end if
