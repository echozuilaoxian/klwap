...
<card id="card1" title="<%=converttowidebaiti(SystemSiteName)%>-学校排行"><p>
<% 
...
Response.write "<br/><a href='/bbs/mysx.asp?SessionID="&SessionID&"'>MY属性</a>|<a href='/bbs/public/ckly.asp?SessionID=" &SessionID & "'>留言(" & lycount & ")条</a>"
  ...
  ssql="select top 10 * from usereg order by (xf+love+qs) desc"
  objgbrs.open ssql,conn
Response.write "<br/>该排行是：情商+爱心+学分<br/>社区学校排行前十：<br/>------------<br/>"
if objgbrs.eof then
Response.write "暂时空缺<br/>"
 Else
For k=1 to 10
bihaocont=bihaocont+1
Response.write bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID& "'>" & converttowidebaiti(objgbrs("usename")) & "ID:" & objgbrs("id") & "</a><br/>总数：(" & objgbrs("qs")+objgbrs("xf")+objgbrs("love") & ")<br/>"
Response.write "当前年级:"
...
if objgbrs.EOF then Exit for
 Next
End if
Response.write "------------<br/><a href='/bbs/school/ph.asp?SessionID="&SessionID&"'>返回排行榜</a><br/>"
