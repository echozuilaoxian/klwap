...
Response.write "我晕,你不是大三的~~<br/><a href='/bbs/school/school.asp?SessionID="&SessionID&"'>返回学校</a><br/>"
    Response.end
  end if  
  '1
if objgbrs("xf")<14250 or objgbrs("qs")<28500 or objgbrs("love")<28500 then
...
sql="update usereg set nianji=16 where CStr(id)='" & iduse & "'"
conn.execute sql
Response.write "恭喜,成为大四的了,继续努力!!"
end if
