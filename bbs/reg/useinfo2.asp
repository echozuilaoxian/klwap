...
Response.write "<br/>职务:<a href='/bbs/xh6666/contentlist.asp?ForumID="&objgbrs("gly")&"&amp;SessionID=" & SessionID & "'>"&converttowidebaiti(bkmc)&"</a>"&converttowidebaiti(bbzz)&""
...
Response.Write "<br/><a href='/bbs/yxxe/tjbg.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>问题报告</a>|<a href='/bbs/friandbook/addcl.asp?frid=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>加" & sexe & "为友</a><br/><a href='postbank.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>过户金币</a>|<a href='/BBS/forum_content/forum_myreceipt.Asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & sexe & "的回帖</a><br/><a href='/bbs/jieh/jie1.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>向" & sexe & "求婚</a>|<a href='/bbs/myalbum/myalbum1.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & sexe & "的相册</a><br/><a href='/bbs/forum_content/bbstdzt.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & sexe & "的帖子</a>|<a href='/bbs/friandbook/addnocl.asp?frid=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>将" & sexe & "加黑</a><br/><a href='/bbs/public/gygl.asp?SessionID=" & SessionID & "'>我的地盘</a>|<a href='/bbs/index.asp?SessionID=" & SessionID & "'>社区首页</a>"
End if
