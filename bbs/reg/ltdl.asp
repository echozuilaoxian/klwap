...
if Session("zh")<>"wap" then
        response.redirect "/BBS/reg/ltdlcl.asp?sjhm="&sjhm&"&pass="&LKXXX&""
     response.end
End if
...
%>
	<card id="login" title="会员登陆">
		...
		<anchor>确定登陆
		<go href="/BBS/reg/ltdlcl.asp?Action=login" method="post">
...
<anchor>确定提交
    <go href="/BBS/UseLogin.asp?Action=save" method="post" accept-charset="utf-8">
		...
		<a href="/BBS/zhmm.asp">[找回密码]</a><br/><a href="/BBS/reg/ltdlcl.asp">[返回登陆]</a><br/>------------<br/><a href="/bbs/index.asp">返回社区首页</a><br/><a href="/index.asp">返回网站首页</a>
		</p>
	</card>
</wml>
<%end sub
...
%>		<card id="login" title="出错了">
		...
		<a href="/BBS/reg/ltdlcl.asp">返回登陆</a><br/><a href="/BBS/UseLogin.asp?Action=reg">免费注册</a><br/>
...
rsll.addnew
rsll("niayo")="欢迎你加入社区这个大家庭，希望在阳光明媚的社区里，你可以找到理想的港湾及理想的人儿。这里，将带给你快乐！"
rsll("ids")=ids
rsll("reids")="0"
rsll.update
rsll.close
set rsll=nothing
%>
<card id="index" title="成功注册" ontimer="/BBS/index.asp?SessionID=<%=SessionID%>"><timer value='20'/>
<p>
恭喜你成功注册<br/>
