...
if objgbrs("fanj")=0 then
     ...
     response.write "<br/><a href='/bbs/chan/fanj.asp?wap=" & wap & "'>社区地产</a><br/><a href='/bbs/index.asp'>返回社区首页</a></p></card></wml>"
	 response.end
    End if		   
if objgbrs("usejf")<0 then response.redirect"signal.asp"
                sql="update usereg set usejf=usejf+400000  where CStr(id)='" & idss & "'" 
			conn.execute sql
...
Response.write "<p>卖房成功!系统已经返还你400000金币了,正在返回..."
