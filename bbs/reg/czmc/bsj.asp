...
if objgbrs("cz")=0 then
     response.write "<card id='card1' title='汽车买卖'><p>你没有宝时捷，赶快去买吧."
...
if objgbrs("usejf")<0 then response.redirect"signal.asp"
                sql="update usereg set usejf=usejf+350000  where CStr(id)='" & idss & "'" 
			conn.execute sql
...
Response.write "<p>成功卖掉你的宝时捷!系统已经返还你350000钻币了,正在返回..."
