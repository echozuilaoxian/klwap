...
if objgbrs("cz")=0 then
     response.write "<card id='card1' title='汽车买卖'><p>你没有法拉利，赶快去买吧."
...
if objgbrs("usejf")<0 then response.redirect"signal.asp"
                sql="update usereg set usejf=usejf+70000  where CStr(id)='" & idss & "'" 
			conn.execute sql
...
Response.write "<p>成功卖掉你的法拉利!系统已经返还你70000钻币了,正在返回..."
