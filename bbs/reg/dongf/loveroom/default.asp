...
' MSN / E-Mail: haikuop@163.com
'============================================================

Dim intRoomId, bRoomId, strRoomPass
...
Sub RoomList()
	...
	If PTW_CustomRoom = 1 Then
		Response.Write "<a href=""" & FilePath & "&amp;act=custom"">自建房间"
	...
	For i = 0 To UBound(strName)
		...
		Response.Write "</a>"
		If strNickName = PTW_AdminName Then Response.Write "<a href=""" & FilePath & "&amp;act=clearapp&amp;id=" & intId(i) & """>清</a>"
		Response.Write "<br/>"
	Next
	...
	Response.Write "<go href=""" & FilePath & "&amp;act=change"" method=""post"">"
...
Sub CustomRoomList()
	...
	Response.Write "<br/>房名<input name=""roomname"" type=""text"" maxlength=""10"" size=""10"" emptyok=""false"" value="" "" />"
	Response.Write "<br/>密码<input name=""roompass"" type=""text"" maxlength=""10"" size=""10""  value="" "" />(必填)"
	Response.Write "<anchor title=""change"">新建房间"
	Response.Write "<go href=""" & FilePath & "&amp;act=custom&amp;type=yes"" method=""post"">"
...
Sub ChatList()
	...
	If strRoomPass <> Empty And Session(PTW_CookieName & "_Login") <> strRoomPass Then		'含有密码保护的房间
		...
		Response.Write "<go href=""" & FilePath & "&amp;type=check&amp;roomid=" & intRoomId &""" method=""post"">"
	...
	If Session(PTW_CookieName & "_ChatReLoad") = Empty Then
		...
		Response.Write "<go href=""" & FilePath & "&amp;type=write&amp;roomid=" & intRoomId &""" method=""post"">"
	...
	If Session(PTW_CookieName & "_ChatReLoad") = Empty Then
		Response.Write "<a href=""" & FilePath & "&amp;type=set&amp;roomid=" & intRoomId & """>自动刷新</a><br/>"
	Else
		Response.Write "<a href=""" & FilePath & "&amp;type=set&amp;roomid=" & intRoomId & """>关闭刷新</a><br/>"
	End If
End Sub
...
Sub ChatForm()
	...
	Response.Write "<go href=""" & FilePath & "&amp;type=write&amp;roomid=" & intRoomId &""" method=""post"">"
	Response.Write "<postfield name=""content"" value=""$content"" />"
	Response.Write "</go></anchor><br/><a href=""" & FilePath & "&amp;roomid=" & intRoomId & """>返回</a><br/>"
End Sub
...
Sub Main()
	...
	If bRoomId = True Or strAct = "custom" Then Response.Write "<a href=""" & FilePath & """>猪窝聊天</a>"
	Response.Write "<br/><a href=""../"">小白猪窝</a>"
	ShowExeTime
End Sub
%>
