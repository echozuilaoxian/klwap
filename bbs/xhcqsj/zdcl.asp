...
jia=int((zuj+100)*0.5)
jia=CLng(jia)
conn.Execute("update usereg set usejf=usejf-" &zuj+100& " where id="& iduse)
conn.Execute("update usereg set usejf=usejf+" &jia& " where id="&hotid)
conn.Execute("update scsj set hue=hue-" &hueee& ",zuj=zuj+100,zu=zu+1,zutime=now  where ids="& hotid)
dong="狂热的"&dong&""
bu="嘴唇"
...
jia=int((zuj+200)*0.5)
jia=CLng(jia)
conn.Execute("update usereg set usejf=usejf-" &zuj+200& " where id="& iduse)
conn.Execute("update usereg set usejf=usejf+" &jia& " where id="&hotid)
conn.Execute("update scsj set hue=hue-" &hueee& ",zuj=zuj+100,zu=zu+1,zutime=now  where ids="& hotid)
dong="凶狠的"&dong&""
bu="嘴唇"
