...
Url="http://wap.2858.cn/lottery/moremsg/index.wml?type_id=2" 
wstr=getHTTPPage(url)            
start=Instr(wstr,"<p>")+0
over=Instr(wstr,"<a href=""/lottery/moremsg/index.wml?type_id=2&amp;type_url=null&amp;type_name=&amp;kind_name=&amp;kind_url=null&amp;page=2"">")+0

body=mid(wstr,start,over-start)
'------------------------------------------------

body = replace(body,"<p>","")
body = replace(body,"null?","balls.asp?")
