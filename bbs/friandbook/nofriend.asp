...
tjhm=objgbrs("friid")
tjhm=replace(tjhm,"*","")
Response.write bihao+bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & tjhm & "&amp;SessionID=" & SessionID & "'>" & converttowidebaiti(redtjname) & "ID:" & tjhm & frionline & "</a>"
Response.write " |<anchor>删除<go method='post' href='subnocl.asp?SessionID=" & SessionID & "'><postfield name='frid' value='" & tjhm & "'/></go></anchor><br/>"
objgbrs.Movenext
