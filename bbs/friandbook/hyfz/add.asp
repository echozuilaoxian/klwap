...
End if
 set rs=Server.CreateObject("ADODB.Recordset")
  ssql1="select * from wry where Cstr(idd)=" & iduse & "  order by id"
rs.open ssql1,conn
if rs.eof then
   Response.write "你没有创建分组<br/>"
 Else
Response.write "请选择分组<br/>------------<br/>"
Response.write "<a href='addcl.asp?idd=0&amp;useid=" & useid & "&amp;SessionID=" & SessionID & "'>系统默认组</a><br/>"
For k=1 to 10
Response.write "<a href='addcl.asp?idd=" & rs("id") & "&amp;useid=" & useid & "&amp;SessionID=" & SessionID & "'>" & rs("country")&"</a><br/>"
rs.Movenext
