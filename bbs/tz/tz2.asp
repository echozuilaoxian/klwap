...
<card id="id" title="猜大小游戏">
<img src='/bbs/tz/dx.gif' alt=''/>
<p>
...
你的选择:<br/>
<anchor>[大]
    <go href="dx1.asp?SessionID=<%=SessionID%>" method="post" accept-charset="utf-8">
...
◆
<anchor>[小]
    <go href="dx2.asp?SessionID=<%=SessionID%>" method="post" accept-charset="utf-8">
        <postfield name="num" value="$(num)"/>
        <postfield name="reid" value="$(reid)"/>
    </go>
</anchor><br/>-----------<br/>
