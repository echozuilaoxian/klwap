...
objgbrss.update 
  ...
  conn.Execute(sql)  
 response.write "你选择:大，对方也选择了大，恭喜你，本次挑战，你赢了" & objgbrss("num") & "枚金币<br/>" 
            ltlyuan="你向会员:[" & objgbrs1("usename") & "ID:" & objgbrs1("id") & "]发出的『猜大小』挑战,你选择:大，对方选择大，很不幸，被对方猜中了，本次挑战你输了" & objgbrss("num") & "枚金币!"
            gftz()
id1=objgbrss("useid")
...
dim talk,sql
talk="[" & objgbrs1("usename") & "]赢了与[" & rs1("usename") & "]『猜大小』的挑战!"
talk=untowide(talk)
...
num=clng(Request("num"))
  ...
  sql="update usereg set usejf=usejf- " & objgbrss("num") & " ,tz2=tz2-1 Where id=" & iduse
  conn.Execute(sql)  
 response.write "你选择:大，对方选择小，很不幸，你猜错了，本次挑战你输了" & objgbrss("num") & "金币<br/>" 
            ltlyuan="你向会员:[" & objgbrs1("usename") & "ID:" & objgbrs1("id") & "]发出的『猜大小』挑战,你选择:小，对方选择大，恭喜你，对方猜错了，本次挑战你赢了" & objgbrss("num") & "枚金币!"
            gftz()
id1=objgbrss("useid")
  set rs1=Server.CreateObject("ADODB.Recordset")
  ssql1="select usename from [usereg] where [id]=" & id1 & " order by id desc"
  rs1.open ssql1,conn,1,1
talk="[" & rs1("usename") & "]赢了与[" & objgbrs1("usename") & "]『猜大小』的挑战!"
talk=untowide(talk)
sql="insert into room1(talk)values("
  sql=sql & sqlstr(talk) & ")"
  Application.Lock
