...
num=clng(Request("num"))
  ...
  conn.Execute(sql)  
 response.write "你选择:布，对方选择了剪刀，很不幸，本次挑战你输了" & objgbrss("num") & "枚金币!<br/>" 
            ltlyuan="你向会员:[" & objgbrs1("usename") & "ID:" & objgbrs1("id") & "]发出的『剪刀石头布』挑战,你选择:剪刀，对方选择布，恭喜你，本次挑战你赢得了" & objgbrss("num") & "枚金币!"
            gftz()
id1=objgbrss("useid")
...
num=clng(Request("num"))
  ...
  sql="update usereg set usejf=usejf+ " & objgbrss("num") & " ,tz=tz+1 Where id=" & iduse
  conn.Execute(sql)  
 response.write "恭喜你，你选择布，对方选择了石头,本次挑战，你赢了" & objgbrss("num") & "枚金币!<br/>" 
            ltlyuan="你向会员:[" & objgbrs1("usename") & "ID:" & objgbrs1("id") & "]发出的『剪刀石头布』挑战,你选择:石头，对方选择了布，很不幸，本次挑战你输了" & objgbrss("num") & "枚金币!"
            gftz()
id1=objgbrss("useid")
  set rs1=Server.CreateObject("ADODB.Recordset")
  ssql1="select usename from [usereg] where [id]=" & id1 & " order by id desc"
...
objgbrss("about2")="C"
objgbrss.update 
 response.write "你选择布，对方也选择了布，本次挑战以平局结束！<br/>" 
            ltlyuan="你向会员:[" & objgbrs1("usename") & "ID:" & objgbrs1("id") & "]发出的『剪刀石头布』挑战,你选择:布，对方也选择了布，本次挑战以平局结束!"
            gftz()
id1=objgbrss("useid")
  set rs1=Server.CreateObject("ADODB.Recordset")
  ssql1="select usename from [usereg] where [id]=" & id1 & " order by id desc"
