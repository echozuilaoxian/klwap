...
<card id="card1" title="娱乐圈-才华排行"><p>
<% 
...
Session("returnuppath")=""
  ...
  ssql="select top 10 * from usereg where gongzuo='2' order by caihua desc"
  objgbrs.open ssql,conn
Response.write "才华排行前十：<br/>------------<br/>"
if objgbrs.eof then
Response.write "暂时空缺<br/>"
 Else
For k=1 to 10
bihaocont=bihaocont+1
Response.write bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & converttowidebaiti(objgbrs("usename")) & "ID:" & objgbrs("id") & "</a><br/>才华：(" & objgbrs("caihua") & ")<br/>"
Response.write "当前职业:"
...
End if
Response.write "------------<br/>"
Response.write "<a href='/bbs/JOB/phe.asp?SessionID="&SessionID&"'>返回排行榜</a><br/>"
