...
if objgbrs("zhiye")=9 and objgbrs("tianshu")>=300 and objgbrs("tili")>=900 and objgbrs("caihua")>=350000 and objgbrs("ml")>=350000 and objgbrs("zhili")>=350000 and objgbrs("xl")>=6 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=10 where CStr(id)='" & iduse & "'"
conn.execute sql
