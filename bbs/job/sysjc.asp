...
if objgbrs("zhiye")=3 and objgbrs("tianshu")>=30 and objgbrs("tili")>=300 and objgbrs("caihua")>=25000 and objgbrs("ml")>=25000 and objgbrs("zhili")>=16000 and objgbrs("xl")>=2 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=4 where CStr(id)='" & iduse & "'"
conn.execute sql
