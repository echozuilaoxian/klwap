...
if objgbrs("zhiye")=4 and objgbrs("tianshu")>=50 and objgbrs("tili")>=400 and objgbrs("caihua")>=40000 and objgbrs("ml")>=40000 and objgbrs("zhili")>=40000 and objgbrs("xl")>=3 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=5 where CStr(id)='" & iduse & "'"
conn.execute sql
