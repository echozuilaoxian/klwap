...
<%
  ...
  '1
if objgbrs("tianshu")<300 or objgbrs("tili")<900 or objgbrs("caihua")<350000 or objgbrs("ml")<350000 or objgbrs("zhili")<350000 or objgbrs("xl")<6 then
Response.write "你的属性还不够,不可以升职!"
end if
if objgbrs("zhiye")=19 and objgbrs("tianshu")>=300 and objgbrs("tili")>=900 and objgbrs("caihua")>=350000 and objgbrs("ml")>=350000 and objgbrs("zhili")>=350000 and objgbrs("xl")>=6 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=20 where CStr(id)='" & iduse & "'"
conn.execute sql
