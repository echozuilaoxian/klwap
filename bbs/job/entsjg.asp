...
if objgbrs("zhiye")=17 and objgbrs("tianshu")>=160 and objgbrs("tili")>=700 and objgbrs("caihua")>=150000 and objgbrs("ml")>=150000 and objgbrs("zhili")>=150000 and objgbrs("xl")>=5 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=18 where CStr(id)='" & iduse & "'"
conn.execute sql
