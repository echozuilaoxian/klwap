...
<card id="card1" title="娱乐圈-智力排行"><p>
<% 
...
Session("returnuppath")=""
  ...
  ssql="select top 10 * from usereg where gongzuo='2' order by zhili desc"
  objgbrs.open ssql,conn
Response.write "智力排行前十：<br/>------------<br/>"
if objgbrs.eof then
Response.write "暂时空缺<br/>"
 Else
For k=1 to 10
bihaocont=bihaocont+1
Response.write bihaocont & "." & "<a href='/bbs/reg/useinfo.asp?id=" & objgbrs("id") & "&amp;SessionID=" & SessionID & "'>" & converttowidebaiti(objgbrs("usename")) & "ID:" & objgbrs("id") & "</a><br/>智力：(" & objgbrs("zhili") & ")<br/>"
Response.write "当前职业:"
