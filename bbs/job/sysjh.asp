...
if objgbrs("zhiye")=8 and objgbrs("tianshu")>=200 and objgbrs("tili")>=800 and objgbrs("caihua")>=220000 and objgbrs("ml")>=220000 and objgbrs("zhili")>=220000 and objgbrs("xl")>=5 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=9 where CStr(id)='" & iduse & "'"
conn.execute sql
