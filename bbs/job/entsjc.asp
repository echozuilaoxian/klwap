...
<%
  ...
  '1
if objgbrs("tianshu")<30 or objgbrs("tili")<300 or objgbrs("caihua")<25000 or objgbrs("ml")<25000 or objgbrs("zhili")<16000 or objgbrs("xl")<2 then
Response.write "你的属性还不够,不可以升职!"
end if
if objgbrs("zhiye")=13 and objgbrs("tianshu")>=30 and objgbrs("tili")>=300 and objgbrs("caihua")>=25000 and objgbrs("ml")>=25000 and objgbrs("zhili")>=16000 and objgbrs("xl")>=2 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=14 where CStr(id)='" & iduse & "'"
conn.execute sql
