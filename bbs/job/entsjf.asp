...
<%
  ...
  '1
if objgbrs("tianshu")<120 or objgbrs("tili")<600 or objgbrs("caihua")<100000 or objgbrs("ml")<100000 or objgbrs("zhili")<100000 or objgbrs("xl")<4 then
Response.write "你的属性还不够,不可以升职!"
end if
if objgbrs("zhiye")=16 and objgbrs("tianshu")>=120 and objgbrs("tili")>=600 and objgbrs("caihua")>=100000 and objgbrs("ml")>=100000 and objgbrs("zhili")>=100000 and objgbrs("xl")>=4 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=17 where CStr(id)='" & iduse & "'"
conn.execute sql
