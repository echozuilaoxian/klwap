...
if objgbrs("zhiye")=6 and objgbrs("tianshu")>=120 and objgbrs("tili")>=600 and objgbrs("caihua")>=100000 and objgbrs("ml")>=100000 and objgbrs("zhili")>=100000 and objgbrs("xl")>=4 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=7 where CStr(id)='" & iduse & "'"
conn.execute sql
