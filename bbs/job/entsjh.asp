...
<%
  ...
  '1
if objgbrs("tianshu")<200 or objgbrs("tili")<800 or objgbrs("caihua")<220000 or objgbrs("ml")<220000 or objgbrs("zhili")<220000 or objgbrs("xl")<5 then
Response.write "你的属性还不够,不可以升职!"
end if
if objgbrs("zhiye")=18 and objgbrs("tianshu")>=200 and objgbrs("tili")>=800 and objgbrs("caihua")>=220000 and objgbrs("ml")>=220000 and objgbrs("zhili")>=220000 and objgbrs("xl")>=5 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=19 where CStr(id)='" & iduse & "'"
conn.execute sql
