...
if objgbrs("zhiye")=2 and objgbrs("tianshu")>=14 and objgbrs("tili")>=200 and objgbrs("caihua")>=10000 and objgbrs("ml")>=10000 and objgbrs("zhili")>=10000 and objgbrs("xl")>=1 then
sql="Delete DATEDIFF FROM gao WHERE Cstr(useid)='" & iduse & "'"
conn.Execute sql
sql="update usereg set zhiye=3 where CStr(id)='" & iduse & "'"
conn.execute sql
