...
if objgbrs("gongzuo")>0 and 1<objgbrs("zhiye")<11 then
...
conn.execute sql
Application.Unlock
msg="你今天任务完成,成功完成任务!<br/>获得金币1000,体力加10,魅力加10,智力加10,才华加10!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="辛苦你了,今天成功完成任务!<br/>获得金币2000,体力加20,魅力加20,智力加20,才华加20!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
 msg="今天任务完成,成功完成任务!<br/>获得金币3000,体力加30,魅力加30,智力加30,才华加30!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币4000,体力加40,魅力加40,智力加40,才华加40!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币5000,体力加50,魅力加50,智力加50,才华加50!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币6000,体力加60,魅力加60,智力加60,才华加60!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币7000,体力加40,魅力加40,智力加40,才华加70!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币8000,体力加80,魅力加80,智力加80,才华加80!!努力工作吧!"
end if
...
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币9000,体力加90,魅力加90,智力加90,才华加90!!努力工作吧!"
end if

'10
if objgbrs("zhiye")=10 then
sql="update usereg set usejf=usejf+10000,ml=ml+100,zhili=zhili+100,caihua=caihua+100,tili=tili+100,tianshu=tianshu+1 where CStr(id)='" & ids & "'"
conn.execute sql
Application.Unlock
msg="今天任务完成,成功完成任务!<br/>获得金币10000,体力加100,魅力加100,智力加100,才华加100!!努力工作吧!"
end if
end if
end if
response.write msg
