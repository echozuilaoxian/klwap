...
next
response.write "<br/>"
if b<40 then response.write "<a href=""nn.asp?id="&request("id")&"&amp;b="&b+2&"&amp;SessionID="&SessionID&""">下页</a>"
if b>2 then response.write " <a href=""nn.asp?id="&request("id")&"&amp;b="&b-2&"&amp;SessionID="&SessionID&""">上页</a> "
