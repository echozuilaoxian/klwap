...
sql="Delete FROM gpmr WHERE CStr(jysl)='0' and DATEDIFF('s', times, now()) > 1*60"
  ...
  ssql="select * from gpmr order by id desc"
...
Response.Write "<a href='gpmjl.asp?pages=" & (pages+1) & "&amp;SessionID=" & SessionID & "'>下页</a>"
End if
If pages>1 then
Response.Write "&nbsp;" & "<a href='gpmjl.asp?pages=" & (pages-1) & "&amp;SessionID=" & SessionID & "'>上页</a>"
End if
