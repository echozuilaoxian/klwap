...
dim id,cc,ForumID,jh,ltname,iduse
...
ids=request("ids")
   ...
   cc=request("jh")
   id=request("id")
if cc="t" then cczz="精华帖子"
if cc="f" then cczz="撤消精华"

  set objgbrs=Server.CreateObject("ADODB.Recordset")
  sql="select * from wuza Where CStr(id)='" & id &"' and jh<>'" & cc & "'"
...
%>
<%if cc="t" then%>
<%sql="update usereg set usejf=usejf+200 Where CStr(id)="&ffid
conn.Execute(sql)%>
<%
...
rsll.addnew
rsll("niayo")="您的帖子["&tzname&"]被版主["&ltname&"(ID:"&iduse&")]加入精华区，系统奖励您200金币，希望您继续努力哦！"
rsll("ids")=ffid
rsll("reids")="0"
rsll.update
rsll.close
