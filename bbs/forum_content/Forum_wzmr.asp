...
ids=request("ids")
   ...
   cc=request("bntj")
   id=request("id")
if cc="t" then cczz="设为名帖"
if cc="f" then cczz="撤消名帖"
  set objgbrs=Server.CreateObject("ADODB.Recordset")
  sql="select * from wuza Where CStr(id)='" & id &"' and bntj<>'" & cc & "'"
...
%>
<%if cc="t" then%>
<%sql="update usereg set usejf=usejf+300 Where CStr(id)="&ffid
conn.Execute(sql)%>
<%
...
rsll.addnew
rsll("niayo")="您的帖子["&tzname&"]被版主["&ltname&"(ID:"&iduse&")]设为名帖，系统奖励您300金币，希望您继续努力哦！"
rsll("ids")=ffid
rsll("reids")="0"
rsll.update
rsll.close
