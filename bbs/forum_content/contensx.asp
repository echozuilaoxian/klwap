...
if objgbrsy.eof then
   Response.write "<card title='&#x51FA;&#x9519;&#x5566;&#x5566;'><p>&#x65E0;&#x6B64;&#x8BBA;&#x575B;！<br/><a href='/bbs/index.asp?SessionID=" & SessionID & "'>&#x8FD4;&#x56DE;</a></p></card></wml>"
response.end
Else
formid=objgbrsy("formid")
...
jiazu=objgbrsy("jiazu")
end if
objgbrsy.close
Set objgbrsy= Nothing

if LX_yxxe=4 and Session("bzbzz")<>"&jiazu&" and Session("Counter")<>"pass_numbers_55556666" then
Response.write "<card id='card1' title='" & converttowidebaiti(dlname) & "-&#x9519;&#x8BEF;&#x63D0;&#x793A;' ontimer='/bbs/index.asp?SessionID=" & SessionID&"'><timer value='500'/><p><b>&#x672C;&#x5E2E;&#x8BBA;&#x575B;&#x9700;&#x8981;&#x52A0;&#x5165;&#x624D;&#x80FD;&#x8BBF;&#x95EE;</b>"
       Session("returnuppath")=Request.ServerVariables("PATH_INFO") & "?forumID="&forumID&"&amp;page="&page&""
response.write "<br/><anchor>&#x6211;&#x8981;&#x52A0;&#x5165;<go method='post' href='/bbs/public/jzjrcl.asp?SessionID=" & SessionID & "'><postfield name='setbzczz' value='" & jiazu & "'/><postfield name='id' value='" & iduse & "'/></go></anchor><br/>"
...
Response.write "<card id='card1' title='" & converttowidebaiti(dlname) & "-&#x9519;&#x8BEF;&#x63D0;&#x793A;' ontimer='/bbs/index.asp?SessionID=" & SessionID&"'><timer value='500'/><p><b>&#x9519;&#x8BEF;&#xFF01;&#x8BE5;&#x7248;&#x5757;&#x53EA;&#x9650;&#x7248;&#x4E3B;&#x8FDB;&#x5165;</b>"
       Session("returnuppath")=Request.ServerVariables("PATH_INFO") & "?forumID="&forumID&"&amp;page="&page&""
response.write "<br/><a href='/BBS/UseLogin.asp?SessionID="&SessionID&"'>&#x7ACB;&#x5373;&#x767B;&#x9646;</a>"
response.write "<br/><a href='/bbs/index.asp?SessionID=" & SessionID & "'>&#x793E;&#x533A;&#x9996;&#x9875;</a></p></card></wml>"
response.end
