...
ids=request("ids")
   ...
   cc=request("tj")
   id=request("id")
if cc="t" then cczz="设为推荐帖"
if cc="f" then cczz="撤消推荐帖"
  set objgbrs=Server.CreateObject("ADODB.Recordset")
  sql="select * from wuza Where CStr(id)='" & id &"' and tj<>'" & cc & "'"
...
%>
<%if cc="t" then%>
<%sql="update usereg set usejf=usejf+1000 Where CStr(id)="&ffid
conn.Execute(sql)%>
<%
...
rsll.addnew
rsll("niayo")="您的帖子["&tzname&"]被版主["&ltname&"(ID:"&iduse&")]设为推荐帖，系统奖励您1000金币，希望您继续努力哦！"
rsll("ids")=ffid
rsll("reids")="0"
rsll.update
rsll.close
