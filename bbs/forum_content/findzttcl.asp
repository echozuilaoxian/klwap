...
if finfrom="1" then
     ssql="select top 100 * from wuza where biaoti like '" & keywords & "' and itid<>'13' order by id desc"
  else
     ssql="select top 100 * from wuza where naiyo like '" & keywords & "' and itid<>'13' order by id desc"
End if
...
For i=1 to 10
   ...
   End if
    ...
    Response.write "<br/>" & converttowide(redtjname) & "ID:" & objgbrs("tjhm") & "(1" & objgbrs("hfcont") & "/6" & objgbrs("rc") & ")"
    objgbrs.Movenext
