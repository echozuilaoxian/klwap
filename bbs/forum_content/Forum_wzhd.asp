...
ids=request("ids")
   ...
   cc=request("hd")
   id=request("id")
if cc="t" then cczz="设为活动帖"
if cc="f" then cczz="撤消活动帖"
  set objgbrs=Server.CreateObject("ADODB.Recordset")
  sql="select * from wuza Where CStr(id)='" & id &"' and hd<>'" & cc & "'"
...
rsll.addnew
rsll("niayo")="您的帖子["&tzname&"]被版主["&ltname&"(ID:"&iduse&")]"&cczz&"，系统奖励您1000金币，希望您继续努力哦！"
rsll("ids")=ffid
rsll("reids")="0"
rsll.update
rsll.close
