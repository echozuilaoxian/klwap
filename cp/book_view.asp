...
page=request("page")
id=request("id")
uuurr = " http://cp.cpcn.mobi/article/book_view.asp?page="&page&"&needpassword=&id="&id&"&sid="
%>
<% 
...
over=Instr(wstr,"<a href=""http://cp.cpcn.mobi/wapindex.asp?siteid=1000"">返回首页</a>")
...
<anchor>返回上级<prev/></anchor><br/><a href="http://xuyes.cn">返回首页</a><br/>
<%end if%>
<%
urlr = replace(uuurr,"&","&amp;")
%><a href=".">中国彩票</a>
<br/><a href="/index.asp?hk=<%=hk%>">网站首页</a><br/>
<b>元旦还有:<% response.write DateDiff("d",Date(),"09-01-01")%>天</b><br/>
</p>
</card>
</wml>
