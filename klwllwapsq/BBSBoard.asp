...
trnb="select * from [sclt] order by [ID] desc"
rsab.open trnb,conn,1,2
yxxeb=rsab.recordcount

set rsac=Server.CreateObject("ADODB.Recordset")
trnc="select * from [sclt] where formid=0  order by [ID] desc"
rsac.open trnc,conn,1,2
yxxec=rsac.recordcount


response.write"现有帖子数量:"&yxxea&"<br/>"
response.write"现有版块数量:"&yxxeb&"<br/>"
response.write"一级版块数量:"&yxxec&"<br/>-------------<br/>"




set rs=Server.CreateObject("ADODB.Recordset")
rsppl="select * from sclt where lx<>500 and did=0 and formid=0 order by pid asc"
...
%>
<a href="BBSBoard.asp?Action=Manage&amp;ID=<%=rs("id")%>&amp;adminmid=<%=request("adminmid")%>">[管理]</a><%=rs("pid")%>.<%=UBB(rs("name"))%><br/>
<%
rs.MoveNext
j=j+1
loop
...
%>
----------<br/>
<a href="BBSBoard.asp?Action=Add&amp;adminmid=<%=request("adminmid")%>">创建版块</a><br/>
<a href="BBSBoard.asp?Action=Defrag&amp;id=0&amp;adminmid=<%=request("adminmid")%>">版块重新排序</a><br/>----------<br/>

<%
Elseif Action="Defrag" then
response.write"<card id='Defrag' title='版块重新排序'><p>"
id=request("id")

set rspx=server.CreateObject("adodb.recordset")
sql="select * from sclt where formid="&id
...
<%
if id=0 then
response.write "-------------<br/><a href='BBSBoard.asp?Action=main&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>返回版块管理</a><br />"
else
response.write "-------------<br/><a href='BBSBoard.asp?Action=Manage&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>返回管理版块</a><br />"
end if
...
sqls = "SELECT * FROM sclt where id="&id
rss.open sqls,conn,1,1
if rss.eof then
response.write"<card id='Manage' title='系统提示'><p>"
response.write"系统提示！无此版块<br/>----------<br/>"
else
name=UBB(rss("name"))
formid=rss("formid")

response.write("<card id='Manage' title='管理版块-"&name&"'><p>")

response.write("版块编号:"&rss("id")&"<br />")

if formid<>0 then
set objgbrsy=Server.CreateObject("ADODB.Recordset")
rspl="select * from sclt where id="&formid
...
response.write("上级版块:"&ubb(classnames)&"("&formid&")<a href='BBSBoard.asp?Action=Manage&amp;ID="&formid&"&amp;adminmid="&request("adminmid")&"'>管理</a><br />")
Else
response.write("上级版块:顶级版块<br />")
end if
...
sqlr="select * from sclt where formid="&ID&" order by pid asc"
...
%>
<%if rsyt("lx")="1" then
Response.Write"<a href='BBSBoard.asp?ID="&rsyt("ID")&"&amp;Action=Manage&amp;Pages="&Pages&"&amp;adminmid="&request("adminmid")&"'>[管理]</a>" & rsyt("pid") & "."&ubb(rsyt("name"))&"<br />"%>
<%elseif rsyt("lx")="0" then
Response.Write"<a href='BBSBoard.asp?ID="&rsyt("ID")&"&amp;Action=Manage&amp;Pages="&Pages&"&amp;adminmid="&request("adminmid")&"'>[管理][文]</a>" & rsyt("pid") & "."&ubb(rsyt("name"))&"<br />"%>
<%elseif rsyt("lx")="2" then
Response.Write"<a href='BBSBoard.asp?ID="&rsyt("ID")&"&amp;Action=Manage&amp;Pages="&Pages&"&amp;adminmid="&request("adminmid")&"'>[管理][连]</a>" & rsyt("pid") & "."&ubb(rsyt("name"))&"<br />"%>
<%end if%>
<%
			jg = jg + 1
rsyt.movenext 
...
if pages<maxpp then
response.write("<a href='BBSBoard.asp?ID=" & ID & "&amp;Action=Manage&amp;adminmid="&request("adminmid")&"&amp;Pages="&pages+1&"'>下页</a>&nbsp;")
end if

if pages>1 and maxpp>1 then
response.write("<a href='BBSBoard.asp?ID=" & ID & "&amp;Action=Manage&amp;adminmid="&request("adminmid")&"&amp;Pages="&pages-1&"'>上页</a>")
end if
...
%>
		      ...
		      <go href="BBSBoard.asp?ID=<%=ID%>&amp;Action=Manage&amp;adminmid=<%=request("adminmid")%>" accept-charset='utf-8'>
		            <postfield name="Pages" value="$(Pages<%=minute(now)%><%=second(now)%>)"/>
		      </go>
		</anchor><br/>
<%end if%>
<a href="BBSBoard.asp?Action=Defrag&amp;id=<%=ID%>&amp;adminmid=<%=request("adminmid")%>">版块重新排序</a><br/>----------<br/>
                <%
rsyt.close
set rsyt=nothing
...
if rss("LX")<>1 then
response.write("<a href='BBSBoard.asp?Action=modify&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>编辑项目</a>◆<a href='BBSBoard.asp?Action=del&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>删除项目</a><br />")
response.write("<a href='BBSBoard.asp?Action=Move&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>移动项目</a>◆合并项目<br />")
else
response.write("<a href='BBSBoard.asp?Action=modify&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>编辑版块</a>◆<a href='BBSBoard.asp?Action=del&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>删除版块</a><br />")
response.write("<a href='BBSBoard.asp?Action=BBSMaster&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>版主管理</a>◆<a href='BBSBoard.asp?Action=BBSLog&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>版主记录</a><br />")
response.write("<a href='BBSBoard.asp?Action=BBSTopic&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>帖子管理</a>◆<a href='BBSBoard.asp?Action=BBSReply&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>回复管理</a><br />")
response.write("<a href='BBSBoard.asp?Action=Move&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>移动版块</a>◆<a href='BBSBoard.asp?Action=Merge&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>合并版块</a><br />")
response.write("----------<br/>")
...
response.write("贴子数量:"&kyaa&"◆精贴数量:"&kyab&"<br/>荐贴数量:"&kyac&"◆<a href='BBSBoard.asp?Action=Manage&amp;ID="&id&"&amp;adminmid="&request("adminmid")&"'>更新帖子</a><br/>")
end if
...
if formid<>0 then
Response.Write"<a href='BBSBoard.asp?ID="&formid&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回上级版快</a><br />"
else
Response.Write"<a href='BBSBoard.asp?ID="&formid&"&amp;Action=main&amp;adminmid="&request("adminmid")&"'>返回版快管理</a><br />"
end if
...
id=request("id")
response.write("<card id='modify' title='编辑版快'><p>")
set rs=Server.CreateObject("ADODB.Recordset")
...
<anchor>修改<go href='BBSBoard.asp?Action=modifyok&amp;adminmid=<%=request("adminmid")%>' method='post' accept-charset='utf-8'>
...
<%
Response.Write"<br/>-----------<br/><a href='BBSBoard.asp?ID="&rs("ID")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回管理版块</a><br/>"
end if
rs.close
set rs=nothing
...
%>
		版快成功编辑！<br/>
<%
Response.Write"-----------<br/><a href='BBSBoard.asp?ID="&rs("ID")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回管理版块</a><br/>"
rs.close
set rs=nothing
...
id=request("id")
response.write("<card id='del' title='删除版快'><p>")

Set rss = Server.CreateObject("ADODB.Recordset")
sqls = "SELECT * FROM sclt where id="&id
rss.open sqls,conn,1,1
if rss.eof then
response.write"错误！无此版快<br/>"
else
...
Else
response.write("版块名称:"&name&"<br />")
response.write("版快说明:"&ubb(rss("shuo"))&"<br />")
response.write("排列顺序:"&rss("pid")&"<br />")
if rss("yc")<>0 then
response.write("公开方式:隐藏<br />")
Else
...
response.write("----------<br/>")
response.write("您确认要删除当前版块？<br />")
response.write("<a href='BBSBoard.asp?Action=delok&amp;ID="&rss("id")&"&amp;adminmid="&request("adminmid")&"'>确认删除</a><br />")
response.write("<a href='BBSBoard.asp?Action=Manage&amp;ID="&rss("id")&"&amp;adminmid="&request("adminmid")&"'>暂不删除</a><br />")
Response.Write"-----------<br/><a href='BBSBoard.asp?ID="&rss("ID")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回"&name&"</a><br/>"
Response.Write"<a href='BBSBoard.asp?Action=main&amp;adminmid="&request("adminmid")&"'>返回版块管理</a><br/>"
...
response.write"错误！无此版快<br/>-----------<br/>"
else
  sql="Delete FROM wuza WHERE itid="&id
  conn.execute(sql)

  sql="Delete FROM sclt WHERE id="&id
  conn.execute(sql)

response.write("<card id='delok' title='删除版快'><p>")
response.write"版快删除成功！<br/>"
Response.Write"-----------<br/>"
Response.Write"<a href='BBSBoard.asp?Action=main&amp;adminmid="&request("adminmid")&"'>返回版块管理</a><br/>"
end if
rss.close
...
name=UBB(rss("name"))
formid=rss("formid")
response.write("<card id='Move' title='移动版块'><p>")
response.write("版块编号:"&rss("id")&"<br />")
...
移动版块，操作需要慎重。<br/>
目标版块:<%
response.write "<select name='kyzc_id'><option>版块列表</option>"
Response.write "<option value='0'>顶级版快</option>"
...
<br/>
<anchor>转移
<go method="post" href='BBSBoard.asp?Action=Moveok&amp;adminmid=<%=request("adminmid")%>'>
...
Response.write "<br/>-----------<br/><a href='BBSBoard.asp?ID="&rss("ID")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回管理版块</a><br/>"
...
sqlss = "SELECT * FROM sclt where id="&kyzc_id
rsss.open sqlss,conn,1,1
if rsss.eof then
response.write("<card id='Move' title='错误提示'><p>")
response.write"错误！无此目标版快<br/>-----------<br/>"
else
...
response.write"非法操作<br/>-----------<br/>"
 ...
 sql="update sclt set formid='"&kyzc_id&"' Where CStr(Id)='" & id & "'"
 conn.execute(sql)

response.write("<card id='Move' title='移动版快'><p>")
response.write"成功移动版快<br/>"
Response.write "-----------<br/><a href='BBSBoard.asp?ID="&rss("ID")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回管理版块</a><br/>"
end if
end if
end if
...
response.write("<card id='Move' title='错误提示'><p>")
response.write"文本版快与连接版快不可以合并！<br/>-----------<br/>"
else

response.write("<card id='Move' title='合并版块'><p>")
response.write("版块编号:"&rss("id")&"<br />")
...
<br/>
<anchor>合并
<go method="post" href='BBSBoard.asp?Action=Mergeok&amp;adminmid=<%=request("adminmid")%>'>
<postfield name="kyzc_id" value="$(kyzc_id)"/>
<%
Response.write "<postfield name='ID' value='" &ID & "'/>"
%>
...
response.write"非法操作<br/>-----------<br/>"
 ...
 sql="Delete FROM sclt Where CStr(Id)='" & id & "'"
 conn.execute(sql)

response.write("<card id='Mergeok' title='合并版快'><p>")
response.write"成功合并版快<br/>"
Response.write "-----------<br/><a href='BBSBoard.asp?ID="&kyzc_id&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>返回目标版块</a><br/>"
end if
end if
end if
...
%>
添加文本版快<br/>-----------<br/>
上级版块:<select name="ForumID<%=minute(now)%><%=second(now)%>"><option>版块列表</option>
<%
Response.write "<option value='0'>顶级版快</option>"
set rsez=server.createobject("ADODB.Recordset")
aqlz="select id,name from sclt order by id desc"
...
<anchor>添加<go href='BBSBoard.asp?Action=Addsave&amp;adminmid=<%=request("adminmid")%>' method='post' accept-charset='utf-8'>
<postfield name='nam' value='$(nam<%=minute(now)%><%=second(now)%>)'/>
<postfield name='txt' value='$(txt<%=minute(now)%><%=second(now)%>)'/>
<postfield name='yc' value='$(yc<%=minute(now)%><%=second(now)%>)'/>
<postfield name='brr' value='$(brr<%=minute(now)%><%=second(now)%>)'/>
...
<%
Response.Write"<br/>-----------<br/><a href='BBSBoard.asp?Action=Add&amp;adminmid="&request("adminmid")&"'>重新选择类型</a><br/>"
%>
<%
...
%>
请选择添加项目类型<br/>-----------<br/>
<a href='BBSBoard.asp?Action=Add&amp;adminmid=<%=request("adminmid")%>&amp;kyzc=bk'>添加版块</a>:功能发帖版块<br/>
<a href='BBSBoard.asp?Action=Add&amp;adminmid=<%=request("adminmid")%>&amp;kyzc=link'>超级连接</a>:直接连接至某个地址<br/>
<a href='BBSBoard.asp?Action=Add&amp;adminmid=<%=request("adminmid")%>&amp;kyzc=wb'>文本内容</a>:文本内容<br/>
<%
Response.Write"-----------<br/><a href='BBSBoard.asp?Action=main&amp;adminmid="&request("adminmid")&"'>返回版块管理</a><br/>"
...
Response.write "成功增加名为<a href='BBSBoard.asp?ID="&rs("id")&"&amp;Action=Manage&amp;adminmid="&request("adminmid")&"'>"&nam&"</a>的版块<br/>-----------<br/><a href='BBSBoard.asp?Action=Add&amp;adminmid="&request("adminmid")&"&amp;Kyzc="&Kyzc&"'>返回继续添加</a><br/>"
rs.close
set rs=nothing
%>
<%
...
<%
set objgbrsy=Server.CreateObject("ADODB.Recordset")
rspl="select * from sclt where id="&rs("itid")
objgbrsy.open rspl,conn,1,2
if objgbrsy.eof then
dlname="无此版快"
Else
...
objgbrsy.close
Set objgbrsy= Nothing%>
<%=(j+(page-1)*listnum)%>.[<a href="BBSBoard.asp?ID=<%=isdd%>&amp;Action=Manage&amp;adminmid=<%=request("adminmid")%>"><%=ubb(dlname)%></a>]<a href="BBSBoard.asp?ID=<%=rs("id")%>&amp;Action=BBSTopicxx&amp;Cpage=<%=page%>&amp;adminmid=<%=request("adminmid")%>&amp;Uid=<%=id%>&amp;useid=<%=useid%>"><%=ubb(rs("biaoti"))%></a>[回<%=usb(rs("hfcont"))%>/阅<%=usb(rs("rc"))%>]<br/><%
...
<small><%=Rs.recordcount%>条记录|<%=listnum%> 条记录/页|共 <%=rs.pagecount%> 页 <br/></small>
      <% if page=1 then %>
      <%else%>
      <a href="BBSBoard.asp?Action=BBSTopic&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=id%>&amp;useid=<%=useid%>">首页</a>
      <a href="BBSBoard.asp?Action=BBSTopic&amp;Page=<%=page-1%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=id%>&amp;useid=<%=useid%>"><b>[<%=page-1%>]</b></a>
      <%end if%><% if rs.pagecount=1 then%><%else%><b>[<%=page%>]</b><%end if%>
<% if rs.pagecount-page <> 0 then %>
      <a href="BBSBoard.asp?Action=BBSTopic&amp;Page=<%=page+1%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=id%>&amp;useid=<%=useid%>"><b>[<%=page+1%>]</b></a>
      <a href="BBSBoard.asp?Action=BBSTopic&amp;page=<%=rs.pagecount%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=id%>&amp;useid=<%=useid%>">尾页</a>
	  <%end if%>
...
<anchor>筛选
    <go href="BBSBoard.asp?Action=BBSTopic&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=id%>" method="post" accept-charset="utf-8">
...
------------<br/>
<% if id <> ""  then %>
<a href="BBSBoard.asp?ID=<%=id%>&amp;Action=Manage&amp;adminmid=<%=request("adminmid")%>">返回管理版快</a><br/>
<%end if%>
...
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=delok">确定</a><br/><a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>">取消</a>
		</p>
	        </card>
</wml>
<%
...
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=delsyok">确定</a><br/><a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>">取消</a>
		</p>
	        </card>
</wml>
<%
...
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=6688">确定</a><br/><a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>">取消</a>
		</p>
	        </card>
</wml>
<%
...
if rs("jh")="t" then yxxe_net1="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=1&amp;USid="&rs("tjhm")&"'>去精</a>"
if rs("jh")="f" then yxxe_net1="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=2&amp;USid="&rs("tjhm")&"'>加精</a>"

if rs("bntjyy1")="t" then yxxe_net2="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=3&amp;USid="&rs("tjhm")&"'>解除</a>"
if rs("bntjyy1")="f" then yxxe_net2="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=4&amp;USid="&rs("tjhm")&"'>锁定</a>"

if rs("times")<>"2100-10-10 12:12:12" then yxxe_net3="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=5&amp;USid="&rs("tjhm")&"'>置顶</a>"
if rs("times")="2100-10-10 12:12:12" then yxxe_net3="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=6&amp;USid="&rs("tjhm")&"'>解除</a>"

if rs("times")<>"2000-10-10 12:12:12" then yxxe_net4="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=7&amp;USid="&rs("tjhm")&"'>固底</a>"
if rs("times")="2000-10-10 12:12:12" then yxxe_net4="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=8&amp;USid="&rs("tjhm")&"'>解除</a>"

if rs("tj")="f" then yxxe_net5="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=9&amp;USid="&rs("tjhm")&"'>推荐</a>"
if rs("tj")="t" then yxxe_net5="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=10&amp;USid="&rs("tjhm")&"'>解除</a>"

if rs("hd")="f" then yxxe_net6="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=11&amp;USid="&rs("tjhm")&"'>活动</a>"
if rs("hd")="t" then yxxe_net6="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=12&amp;USid="&rs("tjhm")&"'>解除</a>"

if rs("bntj")="f" then yxxe_net7="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=13&amp;USid="&rs("tjhm")&"'>名帖</a>"
if rs("bntj")="t" then yxxe_net7="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=14&amp;USid="&rs("tjhm")&"'>解除</a>"

if rs("a")="f" then yxxe_net8="<b>否</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=15&amp;USid="&rs("tjhm")&"'>强贴</a>"
if rs("a")="t" then yxxe_net8="<b>是</b>|<a href='BBSBoard.asp?Action=BBSTopicxx&amp;Page=" & Page & "&amp;CPage=" & CPage & "&amp;adminmid=" & request("adminmid") & "&amp;id="&id&"&amp;Uid="&Uid&"&amp;Useid="&Useid&"&amp;cz=16&amp;USid="&rs("tjhm")&"'>解除</a>"
...
<%
		...
		Response.Write "<a href='BBSBoard.asp?Action=BBSTopicxx&amp;ID="&id&"&amp;CPage=" & cpage & "&amp;Useid=" & Useid & "&amp;Uid=" & Uid & "&amp;Page=" & page+1 & "&amp;adminmid="&request("adminmid")&"'>下页</a>"
		end if

    		if page<=1 then
        	'Response.Write ("&#x4E0A;&#x9875;")
    		else    
       		Response.Write "<a href='BBSBoard.asp?Action=BBSTopicxx&amp;ID="&id&"&amp;CPage=" & cpage & "&amp;Useid=" & Useid & "&amp;Uid=" & Uid & "&amp;Page=" & page-1 & "&amp;adminmid="&request("adminmid")&"'>上页</a>"
   		end if
		...
		<anchor>&#x8DF3;&#x9875;
		<go href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>" accept-charset='utf-8'>
...
%>
所属版面:<a href="BBSBoard.asp?ID=<%=idddd%>&amp;Action=Manage&amp;adminmid=<%=request("adminmid")%>"><%=uBB(dlname)%></a><br/>
...
回复数量:<a href="BBSBoard.asp?Action=BBSReply&amp;WzID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>"><%=rs("hfcont")%></a><br/>
点击数量:<%=usb(rs("rc"))%><br/>
...
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=88">加黑作者</a>◆<a href="BBSBoard.asp?Action=BBSReply&amp;WzID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>">回复管理</a><br/>
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=dels">删除贴子</a>◆<a href="BBSBoard.asp?Action=BBSTopicxx&amp;ID=<%=ID%>&amp;CPage=<%=CPage%>&amp;Useid=<%=Useid%>&amp;Uid=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>&amp;USid=<%=rs("tjhm")%>&amp;Cz=delsy">清空帖子</a>
<%
...
%>
<br/>----------<br/>
<a href="BBSBoard.asp?Action=BBSTopic&amp;Page=<%=CPage%>&amp;Useid=<%=Useid%>&amp;ID=<%=Uid%>&amp;adminmid=<%=request("adminmid")%>">返回帖子管理</a><br/>
...
<small><%=Rs.recordcount%>条记录|<%=listnum%> 条记录/页|共 <%=rs.pagecount%> 页 <br/></small>
      <% if page=1 then %>
      <%else%>
      <a href="BBSBoard.asp?Action=BBSReply&amp;adminmid=<%=request("adminmid")%>&amp;WzID=<%=WzID%>&amp;Cpage=<%=Cpage%>&amp;useid=<%=useid%>">首页</a>
      <a href="BBSBoard.asp?Action=BBSReply&amp;Page=<%=page-1%>&amp;adminmid=<%=request("adminmid")%>&amp;Cpage=<%=Cpage%>&amp;WzID=<%=WzID%>&amp;useid=<%=useid%>"><b>[<%=page-1%>]</b></a>
      <%end if%><% if rs.pagecount=1 then%><%else%><b>[<%=page%>]</b><%end if%>
<% if rs.pagecount-page <> 0 then %>
      <a href="BBSBoard.asp?Action=BBSReply&amp;Page=<%=page+1%>&amp;adminmid=<%=request("adminmid")%>&amp;Cpage=<%=Cpage%>&amp;WzID=<%=WzID%>&amp;useid=<%=useid%>"><b>[<%=page+1%>]</b></a>
      <a href="BBSBoard.asp?Action=BBSReply&amp;page=<%=rs.pagecount%>&amp;adminmid=<%=request("adminmid")%>&amp;Cpage=<%=Cpage%>&amp;WzID=<%=WzID%>&amp;useid=<%=useid%>">尾页</a>
	  <%end if%>
<% if rs.pagecount-page <> 0 or page>1 then %>
      <br/>
	  <%end if%>
...
搜ＩＤ:<input name="useid" title="筛选" size="12" value=""/><br/>
<anchor>筛选
    <go href="BBSBoard.asp?Action=BBSReply&amp;adminmid=<%=request("adminmid")%>&amp;Cpage=<%=Cpage%>&amp;WzID=<%=WzID%>" method="post" accept-charset="utf-8">
        <postfield name="useid" value="$(useid)"/>
	</go>
</anchor>
<% if useid <> "" or wzid<>"" then %>
&nbsp;&nbsp;<a href="BBSBoard.asp?Action=BBSReply&amp;adminmid=<%=request("adminmid")%>">全部回复</a>
<%end if%>
<br/>
------------<br/>
<% if wzid<>"" then %>
<a href="BBSBoard.asp?Action=BBSTopicxx&amp;Useid=<%=Useid%>&amp;Cpage=<%=Cpage%>&amp;ID=<%=wzid%>&amp;adminmid=<%=request("adminmid")%>">返回管理帖子</a><br/>
...
<%
set objgbrsy=Server.CreateObject("ADODB.Recordset")
rspl="select * from sclt where id="&rs("ltid")
objgbrsy.open rspl,conn,1,2
if objgbrsy.eof then
dlname="无此版块"
Else
...
<small><%=Rs.recordcount%>条记录|<%=listnum%> 条记录/页|共 <%=rs.pagecount%> 页 <br/></small>
      <% if page=1 then %>
      <%else%>
      <a href="BBSBoard.asp?Action=BBSLog&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=ID%>&amp;useid=<%=useid%>">首页</a>
      <a href="BBSBoard.asp?Action=BBSLog&amp;Page=<%=page-1%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=ID%>&amp;useid=<%=useid%>"><b>[<%=page-1%>]</b></a>
      <%end if%><% if rs.pagecount=1 then%><%else%><b>[<%=page%>]</b><%end if%>
<% if rs.pagecount-page <> 0 then %>
      <a href="BBSBoard.asp?Action=BBSLog&amp;Page=<%=page+1%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=ID%>&amp;useid=<%=useid%>"><b>[<%=page+1%>]</b></a>
      <a href="BBSBoard.asp?Action=BBSLog&amp;page=<%=rs.pagecount%>&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=ID%>&amp;useid=<%=useid%>">尾页</a>
	  <%end if%>
<% if rs.pagecount-page <> 0 or page>1 then %>
      <br/>
	  <%end if%>
...
搜ＩＤ:<input name="useid" title="筛选" size="12" value=""/><br/>
<anchor>筛选
    <go href="BBSBoard.asp?Action=BBSLog&amp;adminmid=<%=request("adminmid")%>&amp;ID=<%=ID%>" method="post" accept-charset="utf-8">
        <postfield name="useid" value="$(useid)"/>
	</go>
</anchor>
<% if useid <> "" or wzid<>"" then %>
&nbsp;&nbsp;<a href="BBSBoard.asp?Action=BBSLog&amp;adminmid=<%=request("adminmid")%>">全部回复</a>
<%end if%>

<br/>
------------<br/>
<% if id<>"" then %>
<a href="BBSBoard.asp?Action=Manage&amp;ID=<%=id%>&amp;adminmid=<%=request("adminmid")%>">返回管理版快</a><br/>
<%
end if
end if
