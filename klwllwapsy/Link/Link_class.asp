...
<a href="Admin_class.asp?sid=<%=sid%>&amp;id=<%=rs("classid")%>"><%=rs("class")%></a>|<a href="editclass.asp?sid=<%=sid%>&amp;id=<%=rs("classid")%>">修改</a>|<a href='delcl.asp?sid=<%=sid%>&amp;id=<%=rs("classid")%>'>删除</a><br/>   
	<%rs.moveNext
 	Next
