...
Sql="select * from [link] Where Active=1 order by time desc"
...
Dim PageSize,i
	...
	Count=conn.execute("Select count(ID) from [link] Where Active=1")(0)
...
<a href="Link_pass.asp?sid=<%=sid%>&amp;act=2">全部通过审核</a><br/>
