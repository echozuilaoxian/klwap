...
<%lid=request.querystring("lid")
 idd=request.querystring("idd")
	...
	Sql = "SELECT name,id from wjfile Where lid="&lid&" order by id desc"
	Rs.Open Sql,conn,1,1
	If Not rs.eof	Then
	PageSize=10					
	Dim Count,page,pagecount,gopage,parent			
	gopage="wjlist.asp?sid="&sid&"&amp;lid="&lid&"&amp;idd="&idd&"&amp;"
...
<br/>--------<br/>
<a href='upfile.asp?sid=<%=sid%>&amp;lid=<%=lid%>&amp;idd=<%=idd%>'>[上传文件]</a><br/>
